...
lista_palabras=["panaderia", "carniceria", "pescaderia", "supermercado", "panadero", "perfumeria", "empanada"]
objetivo="pan"
...
from functools import reduce # importamos la función reduce utilizando el módulo functools
...
def buscar_nombre_en_lista():
    ...
    entrada = input("Ingresa una lista de nombres separados por comas (ej: Ana, Juan, Pedro): ")
...
class NombreNoEncontradoError(Exception):
    """Excepción personalizada para cuando un nombre no se encuentra en la lista."""
    pass

def buscar_nombre():
    # Solicitar lista de nombres al usuario
    lista = input("Ingresa una lista de nombres separados por comas: ").split(",")
    lista = [nombre.strip() for nombre in lista]  # eliminamos espacios extra
...
def buscar_nombre():
    # Solicitar lista de nombres al usuario
    lista = input("Pepe, Maria, Carmen, Luis, Lucia: ").split(",")
    lista = [nombre.strip() for nombre in lista]  # eliminamos espacios extra

    # Solicitar nombre a buscar
    nombre_buscar = input("Carmen: ").strip()
...
# %%
lista = ("Pepe, Maria, Carmen, Luis, Lucia")
nombre_buscar = ("Carmen")
print (buscar_nombre)
